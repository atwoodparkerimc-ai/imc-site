...
import { OrbitControls, Edges, Float, PerspectiveCamera } from "@react-three/drei";
    ...
    <div className="w-full max-w-[1400px] mx-auto text-slate-200" suppressHydrationWarning>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        <div className="lg:col-span-4 flex flex-col h-full gap-4">
          ...
          <div className="p-5 rounded-lg border border-slate-800 bg-[#030914] flex flex-col gap-3 mt-auto">
            <div className="flex items-center gap-2.5">
              <ShieldCheck className="w-5 h-5 text-emerald-500" />
              <h4 className="font-mono text-[11px] font-bold text-slate-200 uppercase tracking-widest">
                Certified Union Craftsmanship
              </h4>
            </div>
            <div className="h-px w-full bg-slate-800" />
            <p className="text-sm text-slate-200 leading-relaxed font-normal">
              Fabricated and install by members of <strong className="text-white font-bold">UA Local 140</strong> (Pipefitters) and <strong className="text-white font-bold">SMW Local 312</strong> (Sheet Metal).
            </p>
          </div>
        </div>

        {/* RIGHT COLUMN: TECHNICAL WORKSTATION */}
        <div className="lg:col-span-8 h-full rounded-lg border border-slate-800 bg-[#040c1a] p-8 sm:p-10 flex flex-col justify-between relative overflow-hidden shadow-2xl">
              ...
              <div className="space-y-5">
                {active.specs.map((spec, i) => (
                  <div key={i} className="flex flex-col">
                    ...
                    <span className="text-sm font-semibold text-slate-400 leading-relaxed">
                      {spec.val}
                    </span>
                  </div>
                ))}
