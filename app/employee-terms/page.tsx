...
export default function EmployeeTermsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#030914] text-slate-200 font-sans selection:bg-[#ea1f27] selection:text-white relative overflow-x-hidden">
      {/* Background Tactical Blueprint Grid */}
      <div className="absolute inset-0 z-0 tactical-graph-paper opacity-20 pointer-events-none" />

      {/* Top Header Bar */}
      <header className="relative z-10 border-b border-slate-800/80 bg-[#070a10]/80 backdrop-blur-md px-6 sm:px-12 py-4 sm:py-5">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <Link 
            href="/dashboard" 
            className="flex items-center gap-3 py-1 min-h-[44px] touch-manipulation select-none active:scale-95 transition-transform"
          >
            <Image
              src="/imclogo.svg"
              alt="IMC Logo"
          ...
          <Link 
            href="/dashboard" 
            className="inline-flex items-center gap-1.5 font-mono text-xs uppercase font-bold tracking-widest text-[#0088ff] hover:text-white active:text-white px-3 py-2 min-h-[44px] rounded-xs border border-transparent hover:border-slate-800 active:bg-slate-900 transition-all active:scale-95 touch-manipulation select-none"
          >
            ← Return to Portal
          </Link>
        </div>
      ...
      {/* Main Document Body */}
      <main className="relative z-10 max-w-4xl mx-auto px-6 sm:px-8 py-10 sm:py-16">
        
        {/* Document Header Lockup */}
        <div className="mb-10 sm:mb-12 border-b border-slate-800 pb-8">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white uppercase tracking-tight font-mono">
        ...
        <div className="space-y-8 sm:space-y-10 font-sans text-sm sm:text-base leading-relaxed text-slate-300">
          ...
          <section className="bg-[#070a10] border border-slate-800 p-6 sm:p-8 rounded-sm shadow-xl relative overflow-hidden">
            ...
            <h2 className="text-base sm:text-lg font-black uppercase text-white font-mono tracking-wider flex items-center gap-2 mb-4">
              <Award className="w-5 h-5 text-[#0088ff] shrink-0" /> 1. Program Scope & Purpose
            </h2>
            <p className="mb-3">
          ...
          <section className="bg-[#070a10] border border-slate-800 p-6 sm:p-8 rounded-sm shadow-xl relative overflow-hidden">
            ...
            <h2 className="text-base sm:text-lg font-black uppercase text-white font-mono tracking-wider flex items-center gap-2 mb-4">
              <DollarSign className="w-5 h-5 text-[#ea1f27] shrink-0" /> 2. No Cash Value & Non-Transferability
            </h2>
            <ul className="space-y-3 list-disc list-inside text-slate-300 font-mono text-xs sm:text-sm leading-relaxed">
              <li>
          ...
          <section className="bg-[#070a10] border border-slate-800 p-6 sm:p-8 rounded-sm shadow-xl relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-[2px] bg-[#0088ff]" />
            <h2 className="text-base sm:text-lg font-black uppercase text-white font-mono tracking-wider flex items-center gap-2 mb-4">
              <UserX className="w-5 h-5 text-[#0088ff] shrink-0" /> 3. Employment Contingency & Forfeiture
            </h2>
            <p className="mb-3">
          ...
          <section className="bg-[#070a10] border border-slate-800 p-6 sm:p-8 rounded-sm shadow-xl relative overflow-hidden">
            ...
            <h2 className="text-base sm:text-lg font-black uppercase text-white font-mono tracking-wider flex items-center gap-2 mb-4">
              <Gift className="w-5 h-5 text-[#00ff9d] shrink-0" /> 4. Reward Requisition, Procurement & Logistics
            </h2>
            <ul className="space-y-3 list-disc list-inside text-slate-300 font-mono text-xs sm:text-sm leading-relaxed">
              <li>
          ...
          <section className="bg-[#070a10] border border-slate-800 p-6 sm:p-8 rounded-sm shadow-xl relative overflow-hidden">
            ...
            <h2 className="text-base sm:text-lg font-black uppercase text-white font-mono tracking-wider flex items-center gap-2 mb-4">
              <AlertTriangle className="w-5 h-5 text-[#fbbf24] shrink-0" /> 5. Program Integrity & Fraud Prevention
            </h2>
            <p className="mb-3">
            ...
            <ul className="space-y-2 list-disc list-inside text-slate-300 font-mono text-xs sm:text-sm mb-4 leading-relaxed">
          ...
          <section className="bg-[#070a10] border border-slate-800 p-6 sm:p-8 rounded-sm shadow-xl relative overflow-hidden">
            ...
            <h2 className="text-base sm:text-lg font-black uppercase text-white font-mono tracking-wider flex items-center gap-2 mb-4">
              <FileText className="w-5 h-5 text-slate-400 shrink-0" /> 6. Tax Obligations & Program Modifications
            </h2>
            <p className="mb-3">
        ...
        {/* Bottom Navigation */}
        <div className="mt-12 sm:mt-16 pt-8 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-xs text-slate-400">
          <p>&copy; {new Date().getFullYear()} Interwest Mechanical Contractors. All Rights Reserved.</p>
          <div className="flex items-center gap-2 sm:gap-4">
            <Link 
              href="/privacy-policy" 
              className="py-2 px-1 text-slate-400 hover:text-white active:text-white transition-colors touch-manipulation"
            >
              Privacy Policy
            </Link>
